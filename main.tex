...
The Department of Data Science recognizes three kinds of faculty members: tenure, teaching, and research.

\begin{itemize}
    \item \textbf{Tenure-track faculty} are department appointees who are tenured or eligible for tenure.
    \item \textbf{Teaching faculty} are department appointees with non-tenure eligible appointments, whether part-time, full-time fixed-term, or full-time renewable, as defined in the CDSP Teaching Faculty Policies.
...
\begin{itemize}
    ...
    \item Proposing new academic programs or modifications to existing ones.
...
\begin{itemize}
    \item Developing and recommending departmental policies related to faculty appointment, promotion, tenure, post-tenure review, and joint appointments.  Any policies related to tenure-track faculty must be affirmed by a majority of tenure-track faculty members in the department.
    \item Advising the Department Chair on the assignment of annual merit scores. Evaluations for tenure-track faculty members must be conducted by tenure-track members.
...
\begin{itemize}
    \item \textbf{Tenure-track:} Teaching, research, and service/governance.
...
\begin{itemize}
    \item \textbf{Tenure-track faculty:} Evaluated on a 7-5-3 scale\footnote{This scale may be modified for individual tenured faculty members. Any such modification must be initiated by the faculty member and approved in writing by the Department Chair and Dean.  Individuals in a tenure track position, but who have not yet been awarded tenure, are not eligible to modify this scale.}:
    \begin{itemize}
...
\begin{enumerate}
    \item The committee will generate a list of no fewer than eight potential external reviewers who meet the ``arm’s length'' criteria as defined by the CDSP Procedures on Tenure, Promotion and Interim Review Processes, Faculty Handbook and associated university guidance.
...
After the external letters have been received and anonymized, the candidate will be given one week (7 calendar days) to submit a written response. Following this, the committee will evaluate the candidate’s full portfolio - including submitted materials, external letters, and any responses - and prepare a written assessment and recommendation.
...
The final report will be submitted to the Dean for further action, pursuant Section III.B.7.b of the Faculty Handbook.
...
\begin{itemize}
    ...
    \item Evidence of excellence in teaching.
\end{itemize}
