...
\begin{itemize}
    ...
    \end{itemize}
    Part-time teaching faculty will receive a rating of ``Exceeds Expectations", ``Meets Expectations", or ``Does Not Meet Expectations" on the basis of the responsibilities specified in their contract.
