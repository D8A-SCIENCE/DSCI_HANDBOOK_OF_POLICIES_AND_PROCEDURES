...
\begin{itemize}
    ...
    \item Proposing new undergraduate academic programs or modifications to existing programs, including proposals for new courses, substantive modifications to existing courses, or the removal of existing courses. A substantive course modification is any change to the course’s catalog-approved description and requirements (e.g., title/number, credits, prerequisites, proficiencies), or a change that would materially revise the course’s core content or expectations (e.g., removing or replacing core concepts or skills).
